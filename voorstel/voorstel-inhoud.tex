...
In het artikel van \textcite{Abraham2023} wordt gewaarschuwd dat scale-to-zero een cold start kan veroorzaken en geven ze de raad om het minimum instanties op één te zetten wanneer de container meer dan tien seconden nodig heeft om op te starten. Dit kan anders voor problemen zorgen, doordat GCR requests niet langer dan tien seconden kan laten wachten \autocite{Abraham2023}.
