...
Door de opkomst van cloud computing is applicatie-ontwikkeling drastisch geëvolueerd. Dit paradigma levert geheugen, computerkracht en services aan via het internet die op aanvraag kunnen op- en afschalen \autocite{Pubglob2024}. Hierdoor zijn bedrijven niet meer genoodzaakt om nieuwe software op fysieke servers of apparaten te installeren, waardoor er minder kosten en tijd gaat naar hardware, configuraties en onderhoud \autocite{SegunFalade2024}. Ook het opschalen van hun capaciteit, wat meestal voor de aankoop van nieuwe servers en complexe integraties zorgt, is eenvoudiger en goedkoper geworden \autocite{SegunFalade2024}.

Het heeft ook gezorgd voor nieuwe technieken om te ontwikkelen, waaronder serverless computing. Ondanks de naam worden er wel servers gebruikt, maar wordt het beheer hiervan ontkoppelt van de ontwikkelaar \autocite{Thatikonda2023}. Deze abstractie versnelt volgens het artikel \textcite{Ghorbian2025} het proces van ontwikkelen, doordat ontwikkelaars niet meer moeten nadenken over het beheer van de onderliggende infrastructuur. Dit zorgt voor een betere kostenefficiëntie en schaalbaarheid \autocite{Thatikonda2023}. Anderzijds wordt er in het artikel \textcite{Chippagiri2025} gesuggereerd dat er problemen kunnen zijn met vendor lock-in, zwakke plekken in de beveiliging, cold starts\footnote{vertraging bij opstart na inactiviteit} en inefficiënte toekenning van resources bij dynamische workloads, waardoor kosten onnodig oplopen. Deze nadelen zijn zeer relevant in dit onderzoek, aangezien ze een directe impact hebben op prestaties en kosten. 
